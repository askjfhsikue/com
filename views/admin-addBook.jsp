          ...
          <ul class="am-list am-collapse admin-sidebar-sub" id="collapse-nav">
            ...
            <c:if test="${types != null}">
              <c:forEach var="type" items="${types}">
                <li><a href="adminPage/getBookByType?bookType=${type}"><span class="am-icon-th"></span> ${type} </a></li>
              </c:forEach>
            </c:if>

          </ul>
        </li>
        <li><a href="adminPage/getAllOrders"><span class="am-icon-table"></span> 查看订单</a></li>
    ...
    <div class="admin-content-body">
      ...
      <div class="am-g">
            ...
            <div class="am-panel-bd">
              <div class="am-g">
                <div class="am-u-md-12">
                  <img class="am-img-circle am-img-thumbnail" src="assets/i/wordLogo.png" alt=""/>
                </div>
              </div>
            </div>
          </div>
        ...
        <div class="am-u-sm-12 am-u-md-8 am-u-md-pull-4">
          <form id="submit-form" class="am-form am-form-horizontal" action="Book/admin/addBook" method="post" enctype="multipart/form-data">
            ...
            <div class="am-form-group">
              ...
              <div class="am-u-sm-9">
                <input required type="text" id="book-press" name="press" placeholder="输入图书出版社">
              </div>
            </div>
              ...
              <div class="am-u-sm-9">
                <div class="am-g">
                  <div class="am-u-sm-4 am-u-md-3 am-u-lg-2">
                    <img class="am-img-circle am-img-thumbnail" src="assets/i/book.png" alt=""/>
                  </div>
